<?php /* Smarty version 2.6.14, created on 2012-09-25 07:02:26
         compiled from /home/daniel_com/danielribeiro.com/karinanork/templates/content/projetos.tpl */ ?>
<?php ob_start();  echo '
...
?>
				  <li class="li"><a href="?page=projetos&p_cat=<?php echo $this->_tpl_vars['item']; ?>
...
"><?php echo $this->_tpl_vars['item']; ?>
        ...
        <td width="191" height="368" bgcolor="#000000" class="border"><table width="171" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>Projetos <?php echo $this->_tpl_vars['parameters']['p_cat']; ?>
</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
" class="thumb_img <?php if ($this->_tpl_vars['key'] == 0): ?>thumb_img_active<?php endif; ?>">
						</li>
					<?php endforeach; endif; unset($_from); ?>
				</ul>
            </div></td>
...
" style="display: <?php if ($this->_tpl_vars['key'] == 0): ?>block<?php else: ?>none<?php endif; ?>;">
				<div>
